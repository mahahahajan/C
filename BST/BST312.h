...
public:
    ...
    *****************************/
    ...
    Preconditions: BST has been initialized
    Postconditions: Returns true if there is no more room to add items, else
    false
    *****************************/
    bool isFull() const;
...
template <class ItemType>
void BST_312<ItemType>::copyTree(TreeNode *&copy,
...
int BST_312<ItemType>::countNodes(TreeNode *t) const {
    ...
    //adding one for the node we just found, then recursively check left and right side
...
template <class ItemType>
void BST_312<ItemType>::preOrderTraversal(TreeNode *t,
...
vector<ItemType> BST_312<ItemType>::preOrderTraversal() {
    // YOUR CODE GOES HERE
    vector<ItemType> preOrderNodes;
    preOrderTraversal(root, preOrderNodes);
    return preOrderNodes;
}

template <class ItemType>
void BST_312<ItemType>::inOrderTraversal(TreeNode *t,
                                         vector<ItemType> &result) const {
    // YOUR CODE GOES HERE
...
vector<ItemType> BST_312<ItemType>::inOrderTraversal() {
    // YOUR CODE GOES HERE
    vector<ItemType> inOrderNodes;
    inOrderTraversal(root, inOrderNodes);
    return inOrderNodes;
}

template <class ItemType>
void BST_312<ItemType>::postOrderTraversal(TreeNode *t,
                                           vector<ItemType> &result) const {
    // YOUR CODE GOES HERE
...
vector<ItemType> BST_312<ItemType>::postOrderTraversal() {
    // YOUR CODE GOES HERE
    vector<ItemType> postOrderNodes;
